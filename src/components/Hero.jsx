            ...
            <div className="container relative" ref={parallexRef}>
                <div className="relative z-1 max-w-[62rem] mx-auto text-center mb-[4rem] md:mb-20 lg:mb-[6rem]">
                    <h1 className="h1 mb-6">
                        ...
                        <span className="inline-block relative">Brainwave <img className="absolute top-full left-0 w-full xl:-mt-2" src={curve} alt="curve" width={624} height={28} /></span>
                    </h1>
                ...
                <div className="relative max-w-[23rem] md:max-w-5xl xl:mb-24">
                    ...
                    <div className="absolute -top-[54%] left-1/2 w-[234%] -translate-x-1/2 md:-top-[46%] md:-[138%] lg:-top-[104%]">
                        <img src={heroBackground} className="w-full" width={1440} height={1080} alt="hero" />
                    </div>
                </div>
            </div>
        </Section>
